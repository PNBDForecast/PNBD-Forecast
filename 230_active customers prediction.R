...
load("results/221_active customers regression models.Rdata")
...
# Comparison with true accuracy
load("results/211_active_customers_real.Rdata")

par(mfrow=(c(2,2)))
plot(tot.correct.real[[2]]$sim_med[real.idx],type="l",col="red", main="sim (26 weeks)",ylim=c(50,100),xlab="",ylab="")
lines(prediction.sim.26[real.idx,2], lty=2)
lines(prediction.sim.26[real.idx,3], lty=2)
plot(tot.correct.real[[2]]$ind_med[real.idx],type="l",col="red", main="ind (26 weeks)",ylim=c(50,100),xlab="",ylab="")
lines(prediction.ind.26[real.idx,2], lty=2)
lines(prediction.ind.26[real.idx,3], lty=2)
plot(tot.correct.real[[2]]$MLE[real.idx],type="l",col="red", main="MLE (26 weeks)",ylim=c(50,100),xlab="",ylab="")
lines(prediction.MLE.26[real.idx,2], lty=2)
lines(prediction.MLE.26[real.idx,3], lty=2)
plot(tot.correct.real[[2]]$heur[real.idx],type="l",col="red", main="heur (26 weeks)",ylim=c(50,100),xlab="",ylab="")
